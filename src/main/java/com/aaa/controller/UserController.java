...
public class UserController extends BaseController {
    ...
    @ResponseBody
    public Object dataGrid(UserVo userVo, Integer page, Integer rows, String sort, String order,String q) {
    ...
    @PostMapping("/tree")
    @ResponseBody
    public Object tree(String organizationId) {
        return userService.selectTree(organizationId);
    }
    /**
     * 添加用户
     *
    ...
    @ResponseBody
    public Object getUserListByRoleId(Long roleid){
