...
<script type="text/javascript">
    $(function() {
        $('#stageEditPid').combotree({
            url : '${path }/stage/tree?orgid='+orgidStage,
            parentField : 'pid',
            lines : true,
            panelHeight : '200',
            value : '${course.pid}',
    ...
    <form id="stageEditForm" method="post">
         <table class="grid">
            ...
            <tr>
                <td>上级课程</td>
                <td colspan="3">
                    <select id="stageEditPid" name="pid" style="width: 200px; height: 29px;"></select>
                    <a class="easyui-linkbutton" href="javascript:void(0)" onclick="$('#stageEditPid').combotree('clear');" >清空</a>
                </td>
            </tr>
        </table>
    </form>
