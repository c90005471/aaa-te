...
<script type="text/javascript">
    $(function() {
        $('#teacherno').combotree({
            url : '${path }/teacherPlanFen/teacher?classid='+classid,
            parentField : 'pid',
            lines : true,
            panelHeight : 'auto'
        }); 
        
        $('#teacherFenPlanAddForm').form({
            url : '${path}/teacherPlanFen/add?classid='+classid+'&classname='+classname,
            onSubmit : function() {
                progressLoad();
            ...
            success : function(result) {
                ...
                if (result.success) {
                    ...
                    var form = $('#teacherFenPlanAddForm');
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
          <form id="teacherFenPlanAddForm" method="post">
            <table class="grid">
             <tr>
                <td>选择要评价的老师</td>
                <td>
