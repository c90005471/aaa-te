...
<div class="login">
	<h2>AAA在线考试系统</h2>
	<div class="login-top">
		<form action="${path}/front/toNewExamPaper" method="post" onsubmit="return checkStu()">
			<h1>
...
<div class="copyright">
	...
	$(function(){
		...
		function checkStu(){
    		...
    		$.post("newCheckExamLogin",{examPaperId:$("#examPaper").val(),stuno:$("#stuno").val(),stuphone:$("#stuphone").val()},function(data){
    			flag = data;
    			if(!data){
