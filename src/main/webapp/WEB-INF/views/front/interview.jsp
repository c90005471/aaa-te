...
function checkStuphone(){
	...
	if(stuphone!=null&&stuphone!=""){
		if(phonereg.test(stuphone)){
			...
			$("#stuphonemsg").text("请输入正确的面试人员手机号");
			return false;
		}
	}else{
...
function checkTeaphone(){
	...
	if(teaphone!=null&&teaphone!=""){
		if(phonereg.test(teaphone)){
			...
			$("#teaphonemsg").text("请输入正确的验证码");
			return false;
		}
	}else{
		$("#teaphonemsg").text("请输入验证码");
		return false;
	}
}
	$(function() {
				...
				<div
					...
					<div style="width: 100%;height: 90%;padding:20px 20px 0px 20px;"" >
						<form id="wordOfMouthForm">
							<span class="msg">*</span>面试人员姓名:<span class="msg" id="stunamemsg" ></span><input id="stuname" name="stuname" onblur="checkStuname()"/>
							<span class="msg">*</span>面试人员手机号:<span class="msg" id="stuphonemsg"></span><input id="stuphone" name="stuphone" onblur="checkStuphone()"/>
							<span class="msg">*</span>面试人员专业:<span class="msg" id="teanamemsg"></span><input id="teaname" name="teaname" onblur="checkTeaname()"/>
							<span class="msg">*</span>验证码:<span class="msg" id="teaphonemsg"></span><input id="teaphone" name="teaphone" onblur="checkTeaphone()"/>
					...
					<div data-role="controlgroup" data-type="horizontal" style="padding-left:30px;text-align: center;">
						<a href="#" data-role="button" id="submitQuestions">开始考试</a> 
					</div>
				</div>
			</div>
		</div>
