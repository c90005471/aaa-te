...
<html>
<head>
    <title>用户登录-AAA软件IT-专业的java学习培训平台</title>
    <meta name="keywords" content="AAA软件,java职业教育,java线教育平台,java在线学习,spring,mybatis,spring-boot,docker">
    <meta name="description" content="AAA软件作为中国最权威的java在线教育平台,拥有海量高清java职业课程,涵盖个个组件,根据java在线学习特点,AAA软件推出java学习知识体系图,java职业学习实战路径图,帮助java学习者从零基础起步,结合java实战案例演练,系统学习,助你快速成为java优秀技术人才！">
...
<div style="text-align:center;">
    <p>
        <a href="http://www.zzaaa.net" target="_blank">AAA软件</a>
