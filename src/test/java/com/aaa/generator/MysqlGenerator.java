...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "C:\\workspace201708\\aaa-te\\src\\main\\java";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		strategy.setInclude(new String[] { "stu_evaluate" }); // 需要生成的表
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.aaa.commons.base.BaseController");
